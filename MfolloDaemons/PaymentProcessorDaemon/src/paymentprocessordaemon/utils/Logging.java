...
public class Logging {
    ...
    private void initializeLoggers() {
        ...
        try {
            ...
            rfaInfoLog.setMaxFileSize(DaemonConstants.MAX_LOG_FILE_SIZE);
            rfaInfoLog.setMaxBackupIndex(
                DaemonConstants.MAX_NUM_LOGFILES);

            RollingFileAppender rfaErrorLog = new RollingFileAppender(layout,
                props.getErrorLogFile(), true);
            rfaErrorLog.setMaxFileSize(DaemonConstants.MAX_LOG_FILE_SIZE);
            rfaErrorLog
                .setMaxBackupIndex(DaemonConstants.MAX_NUM_LOGFILES);
