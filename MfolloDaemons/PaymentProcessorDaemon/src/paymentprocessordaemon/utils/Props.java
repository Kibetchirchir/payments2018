package paymentprocessordaemon.utils;
...
public final class Props {
     ...
     * Wallet Gateway URL.
     */
    private transient String walletGatewayURL;
    /**
    ...
    /**
     * The properties file.(Absolute Path set to fix a location bug on server)
     */
    ...
    private void loadProperties(final String propsFile) {
        ...
        try {
            ...
            if (getHubAPIUrl().isEmpty()) {
             ...
             walletGatewayURL = props.getProperty("WalletGatewayURL");
            if (getHubAPIUrl().isEmpty()) {
                getLoadErrors().add(String.format(error2, "HubApiUrl"));
            }
   ...
   String retry = props.getProperty("RetryStatus");
     ...
     * @return the Beep API URL
     */
    public String getWalletGatwayURL() {
        return walletGatewayURL;
    }
    /**
     * No of threads that will be created in the thread pool to process
     * payments.
