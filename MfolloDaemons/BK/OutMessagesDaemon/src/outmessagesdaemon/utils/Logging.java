...
public class Logging {
    ...
    private void initializeLoggers() {
        ...
        try {
            ...
            rfaInfoLog.setMaxFileSize(OutMessagingConstants.MAX_LOG_FILE_SIZE);
            rfaInfoLog.setMaxBackupIndex(
                OutMessagingConstants.MAX_NUM_LOGFILES);

            RollingFileAppender rfaErrorLog = new RollingFileAppender(layout,
                props.getErrorLogFile(), true);
            rfaErrorLog.setMaxFileSize(OutMessagingConstants.MAX_LOG_FILE_SIZE);
            rfaErrorLog
                .setMaxBackupIndex(OutMessagingConstants.MAX_NUM_LOGFILES);
