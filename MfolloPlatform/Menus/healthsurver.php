...
class Menu {
    ...
    public function processMenu() {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "http://127.0.0.1/MfolloPlatform/Menus/mhealth.php?MSISDN=".$this->MSISDN."&NEXT_LEVEL=".$this->NEXT_LEVEL."&USSD_STRING=".$this->USSD_STRING."&EXTRA=".rawurlencode($this->EXTRA));
