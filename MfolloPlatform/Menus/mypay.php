...
class Menu {
    ...
    public function processMenu() {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://www.ghris.go.ke/VAS/GPAS/Navigator.ashx?MSISDN=$this->MSISDN&NEXT_LEVEL=$this->NEXT_LEVEL&USSD_STRING=$this->USSD_STRING&EXTRA=".rawurlencode($this->EXTRA));
