...
class mpesaIPN {
    ...
    {
        $table = "paymentLogs";
        $values = array("trxID" => $this->TRXID, "MSISDN" => $this->MSISDN, "trxRefNo" => $this->TRXREF, "trxAccountNo" => $this->TRXACCOUNT, "trxTimeStamp" => $this->TRXTIME, "trxSenderName" => $this->TRXTIME,  "dateCreated" => date("Y-m-d H:i:s"));
        $logged = D4M::createInstance(Props::$DBHOST, Props::$DBUSER, Props::$DBPASS, 'mfollopg')->DoInsert($table, $values);
